...
* [Thymeleaf](https://docs.spring.io/spring-boot/3.5.4-SNAPSHOT/reference/web/servlet.html#web.servlet.spring-mvc.template-engines)
...
* [Validation](https://docs.spring.io/spring-boot/3.5.4-SNAPSHOT/reference/io/validation.html)
